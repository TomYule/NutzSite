package io.nutz.nutzsite.common.wxpay;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import io.nutz.nutzsite.common.wxpay.config.WXPayConfig;
...
public class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        public ReportInfo(String uuid, long timestamp, long elapsedTimeMillis, String firstDomain, boolean primaryDomain,
    ...
    private WXPayReport(final WXPayConfig config) {
        ...
        ThreadFactory namedThreadFactory = new ThreadFactoryBuilder()
                .setNameFormat("wxpay-pool-%d").build();
